...
class OfflineDownloadActivity : AppCompatActivity() {
  ...
  private fun initZoomLevelTextviews() {
    binding.textViewMaxText.text = getString(R.string.max_zoom_textview, binding.seekbarMaxZoom.progress)
    binding.textViewMinText.text = getString(R.string.min_zoom_textview, binding.seekbarMinZoom.progress)
  }

...
dependencies {
    implementation 'org.maplibre.android:maplibre-android-plugin-scalebar-v9:0.5.0'
}
```
...
// In the app build.gradle file
dependencies {
    implementation 'org.maplibre.android:maplibre-android-plugin-scalebar-v9:0.6.0-SNAPSHOT'
}
```
